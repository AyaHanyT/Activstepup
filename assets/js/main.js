!(function ($) {
  ...
  if ($('.nav-menu').length) {
    ...
    $('#header .gap-20').prepend('<button type="button" class="mobile-nav-toggle d-lg-none"><i class="fal fa-bars"></i></button>');
...
var tooltip_tool = document.getElementById('language')
var tooltip = new bootstrap.Tooltip(tooltip_tool, options)
